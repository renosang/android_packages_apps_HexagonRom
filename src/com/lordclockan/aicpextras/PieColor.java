...
public class PieColor extends SubActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        getFragmentManager().beginTransaction().replace(android.R.id.content,
                new PieColorFragment()).commit();
    }

    public static class PieColorFragment extends PreferenceFragment
        ...
        private static final String PA_PIE_COLOR_RESET = "pa_pie_color_reset";
        ...
        public void refreshSettings() {
            ...
            mResetColor = findPreference(PA_PIE_COLOR_RESET);
        }
        ...
        public static class MyAlertDialogFragment extends DialogFragment {
            ...
            PieColorFragment getOwner() {
                return (PieColorFragment) getTargetFragment();
            }
